...
DEFAULT_PRICING: dict[str, dict[str, Decimal]] = {
    ...
    "geo.search.openai": {
        ...
        "output_million_cny": Decimal("24"),
    },
    "geo.search.perplexity": {
        "input_million_cny": Decimal("8"),
        "output_million_cny": Decimal("8"),
    },
    "geo.search.gemini": {
        "input_million_cny": Decimal("3"),
        "output_million_cny": Decimal("12"),
    },
}
...
def settle_usage(
    ...
    if capability.startswith(("text.", "geo.search.")) or capability == "embedding.standard":
