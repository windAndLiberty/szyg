...
class TestMemoryModule:
    ...
    def test_concurrent_access(self, memory_db: sqlite3.Connection):
        """
        ...
        def write_task(content: str) -> int:
            return store_memory(memory_db, content, None)
    ...
    def test_vector_search_placeholder(self, memory_db: sqlite3.Connection):
        ...
        assert list(retrieved) == pytest.applox(vector, abs=1e-5), (
