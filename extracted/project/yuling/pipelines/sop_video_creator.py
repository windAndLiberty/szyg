...
用法:
    python -m yuling.pipelines.sop_video_creator
"""
...
from yuling.agent_core.sop_manager import SOPManager
...
from yuling.pipelines.video_creator import VideoCreator
