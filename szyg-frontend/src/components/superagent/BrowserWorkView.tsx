    ...
    <aside className="relative flex min-h-0 shrink-0 flex-col border-l border-[#243047] bg-[#0B1020]" style={{ width }}>
      ...
      <header className="flex h-14 shrink-0 items-center gap-3 border-b border-[#243047] px-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-sm font-medium text-[#F4F7FF]">{taskTitle || '浏览器操作'}</p>
        </div>
        {paused ? (
          ...
          <button onClick={handleTakeover} className="inline-flex h-8 items-center gap-1.5 px-2.5 text-xs text-[#CBD5E1] hover:bg-[#1E293B]" title="接管浏览器">
        ...
        {!hasDesktopBrowser && (
          <div className="absolute inset-0 grid place-items-center px-10 text-center">
            <div>
              ...
              <p className="text-sm text-[#CBD5E1]">浏览器操作将在桌面版中实时显示</p>
              <p className="mt-1 text-xs text-[#64748B]">当前开发网页不承载本机浏览器窗口</p>
            </div>
          </div>
        )}
      </div>
