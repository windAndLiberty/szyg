    ...
    <div ref={rootRef} className="relative w-full">
      <div className="rounded-2xl border border-[#273449] bg-[#111827]/95 shadow-[0_16px_50px_rgba(0,0,0,0.26)] transition focus-within:border-[#46536A] focus-within:ring-1 focus-within:ring-[#6366F1]/20">
        ...
        <div className="flex items-center gap-2 px-3 pb-3">
          ...
          <span className="ml-auto hidden text-[11px] text-[#64748B] sm:inline">Enter 发送 · Shift+Enter 换行</span>
          <button
            type="button"
            onClick={onSend}
            disabled={!canSend}
      ...
      {menuOpen && menuPosition && createPortal(
        ...
        >
          ...
          >
            ...
            <span>
              <span className="block font-medium">上传附件</span>
              <span className="block text-[11px] text-[#64748B]">文档、表格、图片、音视频，单个不超过 80 MB</span>
            </span>
          </button>

          <div className="my-1.5 h-px bg-[#273449]" />
          <div className="px-3 pb-1 pt-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-[#64748B]">常用技能</div>
              ...
              >
                ...
                <span className="min-w-0">
                  <span className="flex items-center gap-2 text-sm font-medium text-[#E2E8F0]">
                    ...
                    {skill.installed && <span className="rounded bg-[#064E3B]/60 px-1.5 py-0.5 text-[9px] text-[#6EE7B7]">已安装</span>}
                  </span>
          ...
          >
            ...
            <span className="font-medium">发现更多技能</span>
