...
const enUS: Record<string, string> = {
  ...
  '报告生成完毕': 'Report ready',
  '团队成员更新配置': 'Team settings updated',
  ...
  '普通用户': 'Member',
  '团队成员': 'Team members',
  '管理团队成员与访问权限。': 'Manage team members and access.',
  '添加成员': 'Add member',
  '活跃': 'Active',
  '待激活': 'Pending',
  '普通成员': 'Member',
  ...
  '保存更改': 'Save changes',
  'Supabase 连接配置尚未开放': 'Supabase connection settings are not available yet.',
  '团队成员邀请功能尚未开放': 'Team invitations are not available yet.',
  ...
  'OEM 白标、品牌名称与视觉定制': 'White-label branding, product naming, and visual customization.',
  '团队成员、角色权限管理': 'Team members, roles, and access control.',
  '套餐、用量与账单管理': 'Plans, usage, and billing management.',
  '运营知识学习与最佳实践': 'Operational knowledge and best practices.',
