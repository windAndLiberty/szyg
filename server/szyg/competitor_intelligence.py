...
def _normalize_business_profile(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "brand_aliases": _split_terms(payload.get("brand_aliases")),
        "products": _split_terms(payload.get("products")),
        "competitors": _split_terms(payload.get("competitors")),
        "languages": _split_terms(payload.get("languages")) or ["zh-CN"],
        "target_questions": _split_terms(payload.get("target_questions")),
        "geo_providers": _split_terms(payload.get("geo_providers")),
