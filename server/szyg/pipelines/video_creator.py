...
用法:
    python -m szyg.pipelines.video_creator "AI发展趋势" 60
"""
...
class VideoCreator:
    ...
    def __init__(self, config: dict | None = None):
        ...
        # 图像
        ve_cfg = cfg.get("volcano_engine", {})
        self.image = VolcanoEngineImageClient(
            api_key=ve_cfg.get("ark_api_key", ""),
            model=ve_cfg.get("image_model", "doubao-seedream"),
        )

        # TTS
        self.tts = VolcanoEngineTTSClient(
            app_id=ve_cfg.get("speech_app_id", ""),
            access_token=ve_cfg.get("speech_access_token", ""),
            voice_type=ve_cfg.get("tts_voice", "zh_female_qingxinnvsheng_mars_bigtts"),
        )
