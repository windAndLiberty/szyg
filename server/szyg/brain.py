"""
[DEPRECATED] Unified Brain — nanobot wrapper.

⚠️  This module is deprecated and will be removed in a future version.
    Use `szyg.brain_hermes` instead — HermesBrain replaces SzygBrain.

    Migration:
        from szyg.brain_hermes import get_brain  # replaces this module
"""
...
import warnings
warnings.warn(
    "szyg.brain is deprecated, use szyg.brain_hermes instead",
    DeprecationWarning,
    stacklevel=2,
)
