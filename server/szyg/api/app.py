...
def create_app() -> FastAPI:
    ...
    from szyg.background_workers import configure_background_workers
    ...
    _try_include(app, "szyg.api.geo_routes")
    ...
    if os.path.isdir(spa_dir):
        ...
        async def serve_spa(full_path: str = ""):
            # Never let the SPA hide a missing backend endpoint. Returning index.html
            # for an unknown API path produces a misleading 200 text/html response,
