...
# These development-machine paths are superseded by the packaged runtime
# locations supplied by Electron. They must not appear in a distributable
# config alongside the credential scrubbing above.
...
def sanitize(value: Any, key: str = "") -> Any:
    ...
    if lowered in SECRET_KEYS or lowered.endswith(("_api_key", "_secret", "_password", "_token")):
        return ""
    if lowered in LOCAL_MACHINE_PATH_KEYS:
        return ""
