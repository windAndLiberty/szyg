...
' Start backend
WshShell.Run "cmd /c cd /d D:\szyg && start /min cmd /c ""set PYTHONPATH=D:\szyg\server && set SZYG_DATA_DIR=D:\szyg\data && D:\szyg\.venv\Scripts\python.exe -m uvicorn szyg.api.app:create_app --host 127.0.0.1 --port 8000 --factory""", 0, False
